...
main:
    ...
    J       finish
# ra(x1)
# Initializes the PDF array by setting all values to 0.
...
# Constructs the PDF by incrementing counts in the bins corresponding to data values.
...
# a1(x11), a2(x12), a3(x13), a4(x14), a5(x15), a6(x16)
_loop2:                         # repeat
