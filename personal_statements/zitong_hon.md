## Personal Statement - Zi Tong Hon
...
The program `F1Assembly.s` implements the F1 light sequence, simulating the behavior where all LEDs light up sequentially and turn off after a random delay generated using an LFSR. For more details, refer to [f1.md](../team_statements/f1.md).
...
[Tests passed](../images/TestEvidence/data_instr_cache_tests_evidence/instr_mem_sys%20test%20passed.png)

[GTKWAVE](../images/TestEvidence/data_instr_cache_tests_evidence/instr__cache_passed.png)
